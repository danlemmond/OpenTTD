...
static int HandleEngineList(RpcClient &client, const CliOptions &opts)
{
	try {
		nlohmann::json params;
...
static int HandleEngineGet(RpcClient &client, const CliOptions &opts)
{
	try {
		if (opts.args.empty()) {
...
static int HandleVehicleBuild(RpcClient &client, const CliOptions &opts)
{
	try {
		nlohmann::json params;
...
static int HandleVehicleSell(RpcClient &client, const CliOptions &opts)
{
	try {
		if (opts.args.empty()) {
			std::cerr << "Error: vehicle ID required\n";
...
static int HandleVehicleClone(RpcClient &client, const CliOptions &opts)
{
	try {
		if (opts.args.empty()) {
			std::cerr << "Error: vehicle ID required\n";
